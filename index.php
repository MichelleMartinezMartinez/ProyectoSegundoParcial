...
<style>
  body {
	...
	color:#edf3ff;
	background:#c8c8c8;
	background:url(https://www.pixel4k.com/wp-content/uploads/2019/03/soft-gradient-color_1551645735.jpg) fixed;
...
.login-wrap{
	...
	min-height:510px;
	position:relative;
	background:url(https://www.pixel4k.com/wp-content/uploads/2019/03/soft-gradient-color_1551645735.jpg) no-repeat center;
	background-size: cover;
...
<<div class="login-wrap">
	<div class="login-html">
        ...
        <form action="acciones.php" method="POST" class="my-5">
					<label for="usuario" class="label">Correo</label>
